...
\begin{figure}
    \begin{center}
        \makebox[\textwidth][c]{\begin{overpic}{Graphics/Ch4/OL_MPC_Framework}
            \put(0,7){\includegraphics[height=3in]{Graphics/Ch4/MPC_Framework}}
         \end{overpic}}
...
\begin{figure}
    ...
    \begin{overpic}{Graphics/Ch4/Node_Structure}
        \put(0,0){\includegraphics{Graphics/Ch4/Model_Structure}}
     \end{overpic}
...
\begin{figure}[htb]
    \begin{center}
        \makebox[\textwidth][c]{\includegraphics{Graphics/Ch4/No_Control_DPC}}
...
\begin{figure}
    \begin{center}
        \includegraphics{Graphics/Ch4/Risk_Fit}
...
\begin{figure}[h]
    \begin{center}
        \makebox[\textwidth][c]{\includegraphics{Graphics/Ch4/Space_Fit}}
...
\begin{figure}
    \begin{center}
        \includegraphics{Graphics/Ch4/Profile_Likelihoods}
...
\begin{figure}[t!]
    \begin{center}
        \includegraphics{Graphics/Ch4/Risk_Split_Scan}
...
\begin{figure}[h]
    \begin{center}
        \includegraphics{Graphics/Ch4/OL_Control_Comparison}
...
\begin{figure}[h]
    \begin{center}
        \includegraphics{Graphics/Ch4/OL_MPC_Comparison}
...
\begin{figure}[h]
    \begin{center}
        \includegraphics{Graphics/Ch4/Obj_Values}
...
\begin{figure}[h]
    \begin{center}
        \includegraphics{Graphics/Ch4/Switch_Time_Scan}
...
\begin{figure}
    \begin{center}
        \includegraphics{Graphics/Ch4/Rho_Homo}
...
\begin{figure}
    \begin{center}
        \includegraphics{Graphics/Ch4/Rho_Hetero}
...
\begin{figure}
    \begin{center}
        \includegraphics{Graphics/Ch4/Rho_Relative}
