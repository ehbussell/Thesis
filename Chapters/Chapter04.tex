...
\begin{figure}[htb]
    \begin{center}
        \raisebox{-0.5\height}{\includegraphics[width=0.4\textwidth]{Graphics/Ch4/MPC_Framework}}
        \hspace{0em}
        \raisebox{-0.5\height}{\includegraphics[width=0.4\textwidth]{Graphics/Ch4/OL_MPC_Framework}}
...
\begin{figure}[htb]
    ...
    \includegraphics[width=0.6\textwidth]{Graphics/Ch4/Node_Structure}
    \includegraphics[width=0.6\textwidth]{Graphics/Ch4/Model_Structure}
...
\begin{figure}[h]
    \begin{center}
        \includegraphics[width=0.95\textwidth]{Graphics/Ch4/Space_Fit}
